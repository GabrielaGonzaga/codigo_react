...
namespace senai.SPMEG.webApi.Controllers
{
    ...
    public class PerfisController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, Perfi perfilAtualizado)
        {
        ...
        public IActionResult GetById(int id)
        {
            ...
            // Retorna a resposta da requisição fazendo a chamada para o método
            return Ok(_perfilRepository.BuscarPorId(id));
        }
        ...
        [Authorize(Roles = "1")]
        [HttpPost]
        public IActionResult Post(Perfi novoPerfil)
        {
            // Faz a chamada para o método
            _perfilRepository.Cadastrar(novoPerfil);
